...
#  打包
- 我不希望服务器纯粹为了使用binlog2sql就去配python环境，所以打个二进制包。
- 安装`pyinstaller `
```
pip install pyinstaller 
```
- 修改`binlog2sql.py`导包（不修改打包后运行会找不到`binlog2sql_util`）
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/c0ea3681a4bd4e44b735db91455cb3d6.png)
-  打包
```
pyinstaller -F binlog2sql/binlog2sql.py
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a703e8193bef4e6494d743991181d324.png)


- 运行
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4b874763609f49b0b6b6795c300f4d62.png)

- 以上是Windows打包，Linux也差不多的步骤。
# 小结
...
- [https://cloud.tencent.com/developer/article/2240271](https://cloud.tencent.com/developer/article/2240271)